"""Основной модуль игры. Позволяет выбрать класс игрока,
атаковать, блокировать, применять умения, тренировать.
"""
...
def defence(char_name: str, char_class: str) -> str:
    """Модуль блокировки ударов персонажем."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Модуль применения умений персонажа."""
    if char_class == 'warrior':
...
def main() -> None:
    """Модуль приветствия и запроса имени игрока."""
